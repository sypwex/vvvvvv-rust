...
echo "============================= copy binaries"
cp -v target/x86_64-unknown-linux-gnu/debug/vvvvvv_on_rust $target_dir/linux/
cp -v target/x86_64-apple-darwin/debug/vvvvvv_on_rust $target_dir/mac/
cp -v target/x86_64-pc-windows-gnu/debug/vvvvvv_on_rust.exe $target_dir/win64/
