...
impl Music {
    ...
    pub fn init(&mut self, fs: &mut filesystem::FileSystem) {
        self.soundTracks = vec![
            SoundTrack::new( "/sounds/jump.wav" ),
            SoundTrack::new( "/sounds/jump2.wav" ),
            SoundTrack::new( "/sounds/hurt.wav" ),
            SoundTrack::new( "/sounds/souleyeminijingle.wav" ),
            SoundTrack::new( "/sounds/coin.wav" ),
            SoundTrack::new( "/sounds/save.wav" ),
            SoundTrack::new( "/sounds/crumble.wav" ),
            SoundTrack::new( "/sounds/vanish.wav" ),
            SoundTrack::new( "/sounds/blip.wav" ),
            SoundTrack::new( "/sounds/preteleport.wav" ),
            SoundTrack::new( "/sounds/teleport.wav" ),
            SoundTrack::new( "/sounds/crew1.wav" ),
            SoundTrack::new( "/sounds/crew2.wav" ),
            SoundTrack::new( "/sounds/crew3.wav" ),
            SoundTrack::new( "/sounds/crew4.wav" ),
            SoundTrack::new( "/sounds/crew5.wav" ),
            SoundTrack::new( "/sounds/crew6.wav" ),
            SoundTrack::new( "/sounds/terminal.wav" ),
            SoundTrack::new( "/sounds/gamesaved.wav" ),
            SoundTrack::new( "/sounds/crashing.wav" ),
            SoundTrack::new( "/sounds/blip2.wav" ),
            SoundTrack::new( "/sounds/countdown.wav" ),
            SoundTrack::new( "/sounds/go.wav" ),
            SoundTrack::new( "/sounds/crash.wav" ),
            SoundTrack::new( "/sounds/combine.wav" ),
            SoundTrack::new( "/sounds/newrecord.wav" ),
            SoundTrack::new( "/sounds/trophy.wav" ),
            SoundTrack::new( "/sounds/rescue.wav" ),
        ];
